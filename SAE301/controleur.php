        ...
        if ($action === 'read') {
            ...
            if ($_SERVER["REQUEST_METHOD"] === "POST") {
                ...
                if (!empty($cours1->id) && !empty($cours1->titre) && !empty($cours1->description)) {
                    ...
                    $cours->modifier($cours1->titre, $cours1->image_src, $cours1->description, $cours1->filtre, $cours1->date, $cours1->durée, $cours1->prix, $cours1->vendeur);
                    $cours->update();
        ...
        if ($action === 'read') {
            ...
            if ($_SERVER["REQUEST_METHOD"] === "POST") {
                ...
                if (!empty($materiel1->id) && !empty($materiel1->titre) && !empty($materiel1->description)) {
                    ...
                    $materiel->modifier($materiel1->titre, $materiel1->image_src, $materiel1->description, $materiel1->filtre, $materiel1->prix, $materiel1->vendeur);
                    $materiel->update();
        ...
        if ($action === 'read') {
            ...
            if ($_SERVER["REQUEST_METHOD"] === "POST") {
                ...
                if (!empty($tuto1->id) && !empty($tuto1->titre) && !empty($tuto1->description)) {
                    ...
                    $tuto->modifier($tuto1->titre, $tuto1->image_src, $tuto1->description, $tuto1->filtre, $tuto1->prix, $tuto1->vendeur, $tuto1->video);
                    $tuto->update();
...
echo $twig->render('page_visiteurs.twig', $templateData);
?>